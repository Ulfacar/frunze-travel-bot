...
async def send_to_client(channel: str, bot_id: str, chat_id: str, text: str) -> None:
    """Отправить текст клиенту в его канал. Бросает ValueError при неизвестном канале."""
