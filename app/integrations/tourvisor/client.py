...
# HTTPS обязателен: логин и пароль уходят параметрами в URL (`authlogin`/`authpass`), и по
# http их видит любой узел на пути. Сервер отвечает по https тем же ответом — проверено
# 15.08.2026 с боевыми кредами на `list.php` (132 города вылета, ошибок нет).
