...
FEATURE_FLAGS = {
    ...
    "channel_heartbeat_enabled": {
        "title": "Сторож живости каналов",
        "desc": ("Следит за каждым номером WhatsApp по отдельности: если по каналу давно "
                 "нет входящих (днём дольше 1,5 часов, ночью дольше 5), присылает "
                 "уведомление владельцу. Ловит случай, когда один номер разлогинился или "
                 "у него слетел вебхук, а остальные работают — раньше это оставалось "
                 "незамеченным часами. Одно уведомление на один простой, не чаще раза "
                 "в 3 часа."),
