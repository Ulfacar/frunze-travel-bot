...
SAFE_WORKVISA_REPLY = (
    "К сожалению, рабочими визами мы не занимаемся — для них нужно приглашение от работодателя, "
    "это отдельная услуга. Мы помогаем с туристическими, гостевыми, деловыми и учебными визами "
    "(например, США — B1/B2, F1, M1) по направлениям, с которыми работаем."
)
