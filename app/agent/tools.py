    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "dates": {
                    "type": "string",
                    "description": ("Даты поездки. Понимаются: «10-16 августа», «8-10 сентября», "
                                    "«август 2026», «10.08.2026-16.08.2026». Указывай ОБЕ границы, "
                                    "если клиент их назвал — из них считается количество ночей."),
                },
                "nights": {
                    "type": "string",
                    "description": ("Количество ночей, если клиент назвал его отдельно от дат "
                                    "(«7 ночей», «10-14 ночей»). Если не назвал — не заполняй, "
                                    "ночи посчитаются из дат."),
                },
                "hotel_stars": {
                    "type": "string",
                    "description": ("Минимальная звёздность отеля: «3», «4», «5». Заполняй, если "
                                    "клиент сказал про звёзды или «хороший/приличный отель»."),
                },
